            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('rooms.create') }}"
                       class="inline-block mb-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">Add New
                        Room</a>
                    @if (session('success'))
                    ...
                    <table class="w-full text-left">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Capacity
                            </th>
                        ...
                        @foreach ($rooms as $room)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">${{ $room->price_per_hour }}</td>
